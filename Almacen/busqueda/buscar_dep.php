...
if ($filas > 0) {
	while($fila = $respuesta->fetch_assoc()){
		...
		$salida["data"].='<td>'.$fila['departamento'] .'</td>';
						...
						$salida["data"].='<td> <a class="enlace" href="/Almacen/editar/editar_Dep.php?id='.$id.'"> <abbr title="Editar"><span class="icono">&#9998;</span></abbr></a>  ';
					

					$salida["data"].= '
								<a class="enlace" href = "/Almacen/eliminar/eliminar_Dep.php?id='.$id.'" > <abbr title="Eliminar"> <span class="icono">&#10006;</span> </abbr> </a> 
							  </td>';
