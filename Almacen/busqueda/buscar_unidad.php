...
if ($filas > 0) {
	while($fila = $respuesta->fetch_assoc()){
		...
		$salida["data"].='<td>'.$fila['Medida'] .'</td>';
						...
						$salida["data"].='<td> <a class="enlace" href="/Almacen/editar/editar_Medida.php?id='.$id.'"> <abbr title="Editar"><span class="icono">&#9998;</span></abbr></a>  ';
					

					$salida["data"].= '
								<a class="enlace" href = "/Almacen/eliminar/eliminar_Medida.php?id='.$id.'" > <abbr title="Eliminar"> <span class="icono">&#10006;</span> </abbr> </a> 
							  </td>';
